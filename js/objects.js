(function() {
    ...
    shoppers.forEach(function (shopper) {
        ...
        if (shopper.amount < 200) {
            ...
            console.log(shopper.name + " spent S" + shopper.amount + " and receives a 12% discount, leaving $" + discountedPrice.toFixed(2) + " to pay.");
        }
    });
    ...
    console.log(createBook("Black Hawk Down", "Mark Bowden"));
